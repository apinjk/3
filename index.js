...
say(`Create By Alfin Faridh Taufiqiy\nTelegram : Apinstoreid1\nInstagram : coreinpin`, {
  ...
  gradient: [randomcolor, randomcolor]
   ...
   console.log(color(`[ # ] MASUKKAN KODENYA : ${code}`, `${randomcolor}`));
}
...
await sleep(30000)
ryoroyko.sendMessage(`6281231948641@s.whatsapp.net`, { text: `ASSALAMUALAIKUM MAS APIN, IJIN MENGGUNAKAN SCRIPTNYA, TERIMAKASIH`})
            }
